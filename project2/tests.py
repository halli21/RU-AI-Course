...
def test(size, search, tests):
    ...
    elif search == "backtracking_mrv_deg":
        print(f"\n\n----TESTING BACKTRACKING USING MRV AND DEGREE HEURISTIC ALGORTIHM AT SIZE {size}----")
    elif search == "backtracking_random":
        print(f"\n\n----TESTING BACKTRACKING USING RANDOM HEURISTIC ALGORTIHM AT SIZE {size}----")
    elif search == "backtracking_forward_check_mrv_deg":
        print(f"\n\n----TESTING BACKTRACKING WITH FORWARD CHECK USING MRV AND DEGREE HEURISTIC ALGORTIHM AT SIZE {size}----")
...
if __name__ == "__main__":
    ...
    backtracking_mrv_deg

    backtracking_forward_check_mrv_deg
